...
export function EditableTextField(props: {
    ...
    return (
        <ControlledEditableTextField
            content={(field?.value ?? defaultValue) as string}
            inline={inline}
            dispatch={dispatch}
        />
    );
...
export function ControlledEditableTextField(props: {
    ...
    const { content, inline, dispatch } = props;
    ...
    return <UncontrolledTextEditable text={content} inline={inline} dispatch={dispatch} onInput={onInput} />;
}
