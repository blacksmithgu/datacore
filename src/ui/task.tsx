...
import { EditableAction, EditableListField, EditableState, TextEditable, useEditableDispatch } from "./editable";
            ...
            <ul class="contains-task-list">
                {items?.map((item, ind) =>
                    item instanceof MarkdownTaskItem ? (
                        <Task state={{ ...rest, states }} item={item} />
                    ) : (
