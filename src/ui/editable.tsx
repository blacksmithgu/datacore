...
export function DateEditable({
    ...
    const editorNode = <DatePicker value={jsDate ?? null} calendarType="gregory" onChange={onChange} />;
        ...
        switch (type) {
            ...
            case "number":
                switch (renderAs) {
                    ...
                    default:
                        return <NumberEditable content={props.content as number} updater={props.updater} />;
                }
            default:
                return (
                    <TextEditable
